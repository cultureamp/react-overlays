...
var Position = (function (_React$Component) {
  ...
  Position.prototype.updatePosition = function updatePosition(placementChanged) {
    ...
    this.setState(_utilsOverlayPositionUtils.calcOverlayPosition(this.props.placement, overlay, target, container, this.props.containerPadding, this.props.avoidScrollAdjustment));
  };
...
Position.propTypes = {
   ...
   */
  avoidScrollAdjustment: _react2['default'].PropTypes.bool
};
